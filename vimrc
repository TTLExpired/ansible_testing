...
map <Leader>b :VimuxCloseRunner<CR>
" nnoremap <leader>r :w \| !python3 %<cr>

" We now utilise Async Shell for script execution
"autocmd! FileType python nnoremap <buffer> <F7> :exec '!python' shellescape(@%, 1)<cr>
autocmd! FileType python nnoremap <buffer> <F7> :exec 'AsyncRun -raw python %'<cr>

" Some quickfix windows commands
" Open up Quikfix menu
:noremap <F9> :call asyncrun#quickfix_toggle(8)<cr>

" Quickfix to open automatically if needed
augroup vimrc
