...
if __name__ == "__main__":
    ...
    # the device we're working on, this time we address interface specific URL
    url = 'http://172.16.7.251/restconf/api/config/native/interface/GigabitEthernet/1/ip/address'
